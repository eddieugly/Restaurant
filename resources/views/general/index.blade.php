            ...
            <div class="card-body">
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="company_name" value="{{ $general ? $general->company_name : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Logo</label>
                <div class="col-sm-12 col-md-7">
                  <div style="background-image: url({{ asset($general ? $general->logo : '') }}); background-size: cover; background-position: center;" id="image-preview" class="image-preview">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="story_title" value="{{ $general ? $general->story_title : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="primary_phone" value="{{ $general ? $general->primary_phone : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Secondary Phone</label>
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="secondary_phone" value="{{ $general ? $general->secondary_phone : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Company Email</label>
                <div class="col-sm-12 col-md-7">
                  <input type="email" class="form-control" name="email" value="{{ $general ? $general->email : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Facebook Link</label>
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="facebook" value="{{ $general ? $general->facebook : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Twitter Link</label>
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="twitter" value="{{ $general ? $general->twitter : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Instagram Link</label>
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="instagram" value="{{ $general ? $general->instagram : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
                <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Delivery Fee</label>
                <div class="col-sm-12 col-md-7">
                  <input type="text" class="form-control" name="delivery_fee" value="{{ $general ? $general->delivery_fee : '' }}">
                </div>
              </div>
              <div class="form-group row mb-4">
