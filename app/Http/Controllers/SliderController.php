...
class SliderController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('slider.index')->with('toast_success', 'Slider Image Added Successfully!');
    }
    ...
    public function update(Request $request, Slider $slider)
    {
        ...
        return redirect()->route('slider.index')->with('toast_success', 'Slider Image Updated Successfully!');
    }
