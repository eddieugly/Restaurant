                        ...
                        <tbody>
                            @foreach ($orders as $item)
                                <tr>
                                    ...
                                    <td><span class="badge {{ $item->order_status === 0 ? 'badge-warning':($item->order_status === 1 ? 'badge-success':'badge-danger') }}">{{ $item->order_status === 0 ? 'pending':($item->order_status === 1 ? 'reserved':'canceled') }}</span></td>
                                            ...
                                            <tbody>
                                                ...
                                                @endphp
                                                    <tr>
                                                        <td>{{ $loop->index + 1 }}</td>
                                                        <td>
                                                            <img width="60" src="{{ asset($order->menu->thumbnail) }}" alt="$order->menu->title">
                                                        </td>
